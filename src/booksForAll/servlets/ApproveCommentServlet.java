...
/**
 * Servlet implementation class ApproveCommentServlet
 */
@WebServlet(
		urlPatterns = "/ApproveCommentServlet",
		initParams = {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			try {
				stmt = conn.prepareStatement(AppConstants.UPDATE_COMMENTS_APPROVE);
