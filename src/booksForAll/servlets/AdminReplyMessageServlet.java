...
/**
 * Servlet implementation class AdminReplyMessageServlet
 */
@WebServlet(
		urlPatterns = "/AdminReplyMessageServlet",
		initParams = {
     ...
     */
    public AdminReplyMessageServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			try {
				stmt = conn.prepareStatement(AppConstants.UPDATE_MESSAGES_ADMINREPLY);
